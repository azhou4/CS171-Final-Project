...
outcomes = ['kir', 'kir_top01', 'kir_top20']
...
print(cols_to_keep)
print("name", get_column_names(outcomes, races, genders, pctiles))
for chunk in pd.read_csv("../data/cleaned_outcomes.csv", chunksize=chunksize, usecols=cols_to_keep):
    chunk.to_csv("../data/clean-pcp.csv", mode='a', index=False)
    #print(chunk.columns)
